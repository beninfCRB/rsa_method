      ...
      <div class="col-md-12 mx-auto">
        <div class="card shadow-lg">
          ...
          <?= $this->session->flashdata('pesan'); ?>
            <form action="<?= base_url('c_petugas/edit/').$data->id_petugas ?>" method="POST">
            <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="kode_petugas">Kode Petugas <span class="text-danger">*</span></label>
                  <input class="form-control" type="number" name="kode_petugas" id="kode_petugas" value="<?= $data->type_of_petugas == 'enc'?dec($data->kode_petugas):$data->kode_petugas ?>">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="nama_petugas" id="nama_petugas" value="<?= $data->type_of_petugas == 'enc'? dec($data->nama_petugas):$data->nama_petugas ?>">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="jabatan" id="jabatan" value="<?= $data->type_of_petugas == 'enc'? dec($data->jabatan):$data->jabatan ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" name="type_of_petugas" type="checkbox" value="enc" id="defaultCheck1" <?= $data->type_of_petugas == 'enc'? 'checked':''  ?>>
