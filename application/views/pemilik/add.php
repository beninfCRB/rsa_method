      ...
      <div class="col-md-12 mx-auto">
        <div class="card shadow-lg">
          ...
          <?= $this->session->flashdata('pesan'); ?>
            <form action="<?= base_url('c_pemilik/add') ?>" method="POST">
              <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="number" name="nik" id="nik" placeholder="Masukan NIK Sesuai di KTP">
                  <small class="form-text text-danger"><?= form_error('nik'); ?></small>
                </div>
                <div class="form-group col-md-6">
                  <label for="nama_pemilik">Nama Lengkap <span class="text-danger">*</span></label>
                  <input class="form-control" type="text" name="nama_pemilik" id="nama_pemilik" placeholder="Masukan Nama Lengkap Sesuai di KTP">
                  <small class="form-text text-danger"><?= form_error('nama_pemilik'); ?></small>
                </div>
                <div class="form-group col-md-6">
                  <label for="alamat">Alamat Lengkap <span class="text-danger">*</span></label>
                  <textarea class="form-control" name="alamat" id="alamat" rows="4" placeholder="Masukan Alamat Sesuai di KTP"></textarea>
                  <small class="form-text text-danger"><?= form_error('alamat'); ?></small>
                </div>
                <div class="form-group">
                  <label for="type_of_pemilik">Keamanan</label>
                  <div class="form-check">
                    <input class="form-check-input" name="type_of_pemilik" type="checkbox" value="enc" id="defaultCheck1">
