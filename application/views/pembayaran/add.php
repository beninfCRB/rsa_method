      ...
      <div class="col-md-12 mx-auto">
        <div class="card shadow-lg">
          ...
          <?= $this->session->flashdata('pesan'); ?>
            <form action="<?= base_url('c_pembayaran/add') ?>" method="POST">
              <div class="form-row">
              <div class="form-group col-md-4">
                  <label for="kode_pembayaran">Kode <span class="text-danger">*</span></label>
                  <input readonly class="form-control" type="text" name="kode_pembayaran" id="kode_pembayaran" value="<?= 'PBYN'.$kode->pembayaran ?>">
                ...
                <div class="form-group col-md-4">
                  <label for="penetapan_id">Kode Penetapan<span class="text-danger">*</span></label>
                  <select class="form-control" name="penetapan_id" id="penetapan_id">
                    <option selected disabled value="">== Pilih Kode Penetapan ==</option>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input class="form-control" type="date" name="di_tetapkan" id="di_tetapkan">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input class="form-control" type="date" name="tanggal_pembayaran" id="tanggal_pembayaran">
                ...
                <div class="form-group col-md-2">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" name="type_of_pembayaran" type="checkbox" value="enc" id="defaultCheck1">
