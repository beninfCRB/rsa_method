      ...
      <div class="col-md-12 mx-auto">
        <div class="card shadow-lg">
          ...
          <?= $this->session->flashdata('pesan'); ?>
            <form action="<?= base_url('c_pendaftaran/add') ?>" method="POST">
              <div class="form-row">

              <div class="form-group col-md-4">
                  <label for="kode_pendaftaran">Kode <?= $title ?><span class="text-danger">*</span></label>
                  <input readonly class="form-control" type="text" name="kode_pendaftaran" id="kode_pendaftaran" value="<?= 'PDT'.$kode->pendaftaran ?>">
                ...
                <div class="form-group col-md-4">
                  <label for="kepemilikan_id">Kepemilikan Kendaraan<span class="text-danger">*</span></label>
                  <select class="form-control" name="kepemilikan_id" id="kepemilikan_id">
                    <option selected disabled value="">== Pilih Kepemilikan Kendaraan ==</option>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="date" name="tanggal_pendaftaran" id="tanggal_pendaftaran" placeholder="Masukan Masa Berlaku Kepemilikan Kendaraan">
                ...
                <div class="form-group col-md-2">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" name="type_of_pendaftaran" type="checkbox" value="enc" id="defaultCheck1">
