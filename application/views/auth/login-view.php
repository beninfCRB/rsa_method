                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-12 mt-4">
                            <img class="rounded mx-auto d-block text-center" src="<?= base_url('assets/img/logo.png'); ?>" alt="" width="auto" height="100px">
                        </div>
                        <div class="col-lg-5">
                                    ...
                                    <form class="user" method="post" action="<?= base_url('c_login'); ?>">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="type_of_login" type="checkbox" value="enc">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Samsat Info @ 2022</div>
                    </div>
                </div>
            </footer>
        </div>
