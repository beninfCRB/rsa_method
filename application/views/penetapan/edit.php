              ...
              <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input readonly class="form-control" type="number" name="d_pkb" id="d_pkb" placeholder="Masukan Denda PKB" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" value="<?= $data->type_of_penetapan=='enc'?dec($data->d_pkb):$data->d_pkb ?>">
                  </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input readonly class="form-control" type="number" name="d_swdkllj" id="d_swdkllj" placeholder="Masukan Denda SWDKLLJ" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" value="<?= $data->type_of_penetapan=='enc'?dec($data->d_swdkllj):$data->d_swdkllj ?>">
                  </div>
