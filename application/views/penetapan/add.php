      ...
      <div class="col-md-12 mx-auto">
        <div class="card shadow-lg">
          ...
          <?= $this->session->flashdata('pesan'); ?>
            <form id="form" action="<?= base_url('c_penetapan/add') ?>" method="POST" enctype="multipart/form-data">
              <div class="form-row">

              <div class="form-group col-md-4">
                  <label for="kode_penetapan">Kode <?= $title ?><span class="text-danger">*</span></label>
                  <input readonly class="form-control" type="text" name="kode_penetapan" id="kode_penetapan" value="<?= 'PNP'.$kode->penetapan ?>">
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input  class="form-control" type="number" name="bbnkb" id="bbnkb" placeholder="Masukan Biaya BBNKB"  onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)">
                  </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input  class="form-control" type="number" name="pkb" id="pkb" placeholder="Masukan Biaya PKB"  onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)">
                  </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input  class="form-control" type="number" name="swdkllj" id="swdkllj" placeholder="Masukan Biaya SWDKLLJ" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)">
                  </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input  class="form-control" type="number" name="stnk" id="stnk" placeholder="Masukan Biaya Penerbitan STNK" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)">
                  </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input  class="form-control" type="number" name="ntkb" id="ntkb" placeholder="Masukan Biaya Penerbita NTKB" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)">
                  </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input readonly class="form-control" type="number" name="total" id="total" placeholder="0">
                  </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="date" name="tanggal_penetapan" id="tanggal_penetapan">
                ...
                <div class="form-group col-md-2">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" name="type_of_penetapan" type="checkbox" value="enc" id="defaultCheck1">
              ...
              <div class="text-right">
                <button type="submit" name="hitung" class="btn btn-primary ml-auto">Simpan</button>
              </div>
