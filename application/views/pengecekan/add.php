      ...
      <div class="col-md-12 mx-auto">
        <div class="card shadow-lg">
          ...
          <?= $this->session->flashdata('pesan'); ?>
            <form action="<?= base_url('c_pengecekan/add') ?>" method="POST">
              <div class="form-row">

              <div class="form-group col-md-6">
                  <label for="kode_pengecekan">Kode <?= $title ?><span class="text-danger">*</span></label>
                  <input readonly class="form-control" type="text" name="kode_pengecekan" id="kode_pengecekan" value="<?= 'PCK'.$kode->pengecekan ?>">
                ...
                <div class="form-group col-md-6">
                  <label for="pendaftaran_id">Kode Pendaftaran <span class="text-danger">*</span></label>
                  <select class="form-control" name="pendaftaran_id" id="pendaftaran_id">
                    <option selected disabled value="">== Pilih Kode Pendaftaran ==</option>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="date" name="tanggal_pengecekan" id="tanggal_pengecekan" placeholder="Masukan Tanggal Pengecekan Kendaraan">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="text" name="denda_pkb" id="denda_pkb" placeholder="Masukan Denda PKB" onkeyup="denda(this.value)" onKeyPress="return isNumberKey(event)">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input readonly class="form-control" type="text" name="total_denda_pkb" id="total_denda_pkb" placeholder="0">
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="input-group">
                  <input class="form-control" type="text" name="denda_swdkllj" id="denda_swdkllj" placeholder="Masukan Denda SWDKLLJ"  onkeyup="denda(this.value)" onKeyPress="return isNumberKey(event)">
                  <div class="input-group-prepend">
                      <div class="input-group-text">Bulan</div>
                    </div>
                    </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <input readonly class="form-control" type="text" name="total_denda_swdkllj" id="total_denda_swdkllj" placeholder="0">
                </div>

                <div class="form-group col-md-2">
                  <label for="type_of_pengecekan">Keamanan</label>
                  <div class="form-check">
                    <input class="form-check-input" name="type_of_pengecekan" type="checkbox" value="enc" id="defaultCheck1">
